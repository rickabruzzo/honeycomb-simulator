...
export const SRE_PERSONA: Persona = {
  ...
  behaviorBrief:
    "Focused on system reliability, debugging speed, and minimizing on-call pain. Values MTTR reduction and observability that helps balance scaling with reliability targets.",
  displaySubtitle: "IC • Reliability-focused • Hands-on technical",
...
export const DEVOPS_PERSONA: Persona = {
  ...
  behaviorBrief:
    "Manages heterogeneous environments and seeks to improve debugging across teams. Values automation and clear prioritization of where to invest effort.",
  displaySubtitle: "IC • Automation-focused • Cross-functional",
  createdAt: new Date().toISOString(),
  createdBy: "system",
  isArchived: false,
...
export const TDM_PERSONA: Persona = {
  ...
  personaType: "Technical Decision-Maker / Engineering Manager",
  ...
  otelFamiliarity: "aware",
  behaviorBrief:
    "Buyer persona focused on team tooling, delivery velocity, and developer retention. Values solutions that improve developer experience and reduce burnout.",
  displaySubtitle: "BUYER • Team-focused • Outcome-driven",
  createdAt: new Date().toISOString(),
  createdBy: "system",
  isArchived: false,
...
export const BUILD_RELEASE_PERSONA: Persona = {
  ...
  behaviorBrief:
    "Focused on reducing build times, improving test reliability, and diagnosing issues in distributed build environments.",
  displaySubtitle: "IC • CI/CD-focused • Efficiency-driven",
  createdAt: new Date().toISOString(),
  createdBy: "system",
  isArchived: false,
...
export const DEVELOPER_PERSONA: Persona = {
  ...
  behaviorBrief:
    "Feature-focused developer who rotates on-call. Wants better visibility into production performance and faster issue identification.",
  displaySubtitle: "IC • Feature-focused • On-call rotation",
  createdAt: new Date().toISOString(),
  createdBy: "system",
  isArchived: false,
  ...
  painAnchors: [
    ...
    {
      id: "code-performance",
      pain: "I don't really know how my code is performing after I ship it.",
      keywords: ["code performance", "production", "ship", "monitoring", "visibility"],
      priority: "primary",
      testPhrases: ["code performing", "after shipping", "production visibility"],
    },
    {
      id: "bug-fix-time",
...
export const PLATFORM_PERSONA: Persona = {
  ...
  behaviorBrief:
    "Focused on providing internal developer platforms and tooling. Values solutions that enable engineering teams and provide visibility into costs and cross-system issues.",
  displaySubtitle: "IC • Infrastructure-focused • Developer enablement",
  createdAt: new Date().toISOString(),
  createdBy: "system",
  isArchived: false,
  ...
  painAnchors: [
    ...
    {
      id: "cost-visibility",
      pain: "We don't have good visibility into costs and resource usage across teams.",
      keywords: ["cost", "resource usage", "capacity", "spending", "efficiency"],
      priority: "primary",
      testPhrases: ["cost visibility", "resource usage", "capacity planning"],
    },
    {
